    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.OrganisationId, t.SubscriberId })
                .ForeignKey("dbo.Organisations", t => t.OrganisationId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Subscribers", "OrganisationId", "dbo.Organisations");
            DropForeignKey("dbo.Organisations", "OwnerId", "dbo.AspNetUsers");
            DropForeignKey("dbo.News", "OrganisationId", "dbo.Organisations");
            DropForeignKey("dbo.Images", "NewsId", "dbo.News");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropIndex("dbo.Subscribers", new[] { "SubscriberId" });
            DropIndex("dbo.Subscribers", new[] { "OrganisationId" });
            DropIndex("dbo.Images", new[] { "NewsId" });
            DropIndex("dbo.News", new[] { "OrganisationId" });
            DropIndex("dbo.Organisations", new[] { "OwnerId" });
